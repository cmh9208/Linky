...
class UserService(object):
    def __init__(self):
        ...
        engine = create_engine(
            "mysql+pymysql://root:root@localhost:3306/linkydb",
            encoding='utf-8')
    ...
    def create_user(self)->[]:
        ...
        '''
        return [user_email, password, nickname, token]


    def create_users(self)->[]:
        rows = [self.create_user() for i in range(100)]
        columns = ['user_email', 'password', 'nickname', 'token']
